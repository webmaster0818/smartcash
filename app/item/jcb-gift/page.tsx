    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">JCBギフトカード買取【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">JCBギフトカードの買取相場</h2>
      ...
      {/* おすすめ業者 */}
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">JCBギフトカード買取おすすめ業者TOP3</h2>
      ...
      {/* JCBギフトカードとは */}
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">JCBギフトカードとは</h2>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. JCBギフトカードは本当に95%で買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. はい。シープチケットなら最大95%で買取可能です。ただし、券種や金額によって換金率は変動します。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. 使用済みのJCBギフトカードでも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。未使用のJCBギフトカードのみが買取対象です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. 折れ曲がったJCBギフトカードでも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
