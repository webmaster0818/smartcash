    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">Amazonギフト券買取【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">Amazonギフト券の買取相場</h2>
      ...
      {/* おすすめ業者 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">Amazonギフト券買取おすすめ業者TOP3</h2>
      ...
      {/* Amazonギフト券とは */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">Amazonギフト券とは</h2>
        <p className="text-gray-700 mb-4">
          Amazonギフト券は、Amazon.co.jpで使えるギフト券です。Eメールタイプ、カードタイプ、チャージタイプなど様々な種類があります。
        </p>
        <div className="bg-blue-50 p-4 rounded">
          <h3 className="font-bold mb-2">種類</h3>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. Amazonギフト券は本当に88%で買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. はい。リセチケットなら最大88%で買取可能です。Eメールタイプが最も高換金率です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. アカウントにチャージ済みのAmazonギフト券でも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。チャージタイプは買取できません。Eメールタイプまたはカードタイプが必要です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. 一部使用したAmazonギフト券でも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。未使用のAmazonギフト券のみが買取対象です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. Amazonギフト券の買取は違法ではありませんか？</h3>
            <p className="text-sm text-gray-700">
