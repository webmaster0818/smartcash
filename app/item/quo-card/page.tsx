export default function QuoCard() {
  const vendors = [
    { rank: 1, name: 'シープチケット', rate: '最大80%', speed: '最短5分', link: '/vendors/sheep-ticket' },
    { rank: 2, name: 'タートルチケット', rate: '最大78%', speed: '最短10分', link: '/vendors/turtle-ticket' },
    { rank: 3, name: 'MOOMIN', rate: '最大76%', speed: '最短15分', link: '/vendors/moomin' },
  ]
    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">QUOカード買取【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">QUOカードの買取相場</h2>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              <tr>
                ...
                <td className="px-4 py-3 text-center text-green-600 font-bold">75〜80%</td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-center">78〜82%</td>
        ...
        <p className="text-xs md:text-xs md:text-sm text-gray-600 mt-3 md:mt-4">
          ※ QUOカードはコンビニで利用できるため人気がありますが、換金率はやや控えめです。
        </p>
      </section>

      {/* おすすめ業者 */}
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">QUOカード買取おすすめ業者TOP3</h2>
      ...
      {/* QUOカードとは */}
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4">QUOカードとは</h2>
        <p className="text-gray-700 mb-4">
          QUOカードは、全国のコンビニ・書店・ドラッグストアなどで使えるプリペイドカードです。身近な店舗で使えるため人気があり、プレゼントや景品として広く流通しています。
        </p>
        <div className="bg-blue-50 p-3 md:p-4 rounded">
          ...
          <ul className="space-y-1 text-xs md:text-sm text-gray-700">
            <li>• 全国のコンビニ・書店・ドラッグストアで利用可能</li>
            <li>• 有効期限なし</li>
            <li>• 券種: 300円、500円、1,000円、3,000円、5,000円、10,000円</li>
            <li>• 残高確認可能</li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. QUOカードは本当に80%で買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. はい。シープチケットなら最大80%で買取可能です。ただし、券種や金額によって換金率は変動します。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. 使いかけのQUOカードでも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。未使用のQUOカードのみが買取対象です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-3 md:pl-4">
            <h3 className="text-base md:text-lg font-bold mb-2">Q. QUOカードPayも買取可能ですか？</h3>
            <p className="text-sm text-gray-700">
              A. QUOカードPay（デジタル版）は買取対象外です。物理カードのみが対象です。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 gap-2 md:gap-4">
        ...
        <a href="/item/tosho-card" className="block bg-white p-4 rounded-lg shadow hover:shadow-lg transition min-h-[80px]">
          <h3 className="text-base md:text-lg font-bold mb-2">図書カード買取 →</h3>
          <p className="text-gray-600 text-sm">図書カードの買取相場と業者</p>
        </a>
