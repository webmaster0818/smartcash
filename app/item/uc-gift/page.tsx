    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">UCギフトカード買取【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">UCギフトカードの買取相場</h2>
      ...
      {/* おすすめ業者 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">UCギフトカード買取おすすめ業者TOP3</h2>
      ...
      {/* UCギフトカードとは */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">UCギフトカードとは</h2>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. UCギフトカードは本当に85%で買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. はい。シープチケットなら最大85%で買取可能です。ただし、券種や金額によって換金率は変動します。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. 使用済みのUCギフトカードでも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。未使用のUCギフトカードのみが買取対象です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. UCギフトカードとVJAギフトカードの違いは？</h3>
            <p className="text-sm text-gray-700">
      ...
      <section className="grid md:grid-cols-2 gap-4">
        ...
        <a href="/item/vja-gift" className="block bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
          <h3 className="font-bold mb-2">VJAギフトカード買取 →</h3>
