    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">全国百貨店共通商品券買取【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">全国百貨店共通商品券の買取相場</h2>
      ...
      {/* おすすめ業者 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">全国百貨店共通商品券買取おすすめ業者TOP3</h2>
      ...
      {/* 全国百貨店共通商品券とは */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">全国百貨店共通商品券とは</h2>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. 全国百貨店共通商品券は本当に92%で買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. はい。シープチケットなら最大92%で買取可能です。需要が高いため、高換金率が期待できます。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. 使用済みの全国百貨店共通商品券でも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
              A. いいえ。未使用の全国百貨店共通商品券のみが買取対象です。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. 折れ曲がった全国百貨店共通商品券でも買い取ってもらえますか？</h3>
            <p className="text-sm text-gray-700">
