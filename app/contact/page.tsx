export default function Contact() {
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="mt-4 bg-blue-50 p-4 rounded">
              <h4 className="font-bold mb-2">メールに記載いただきたい内容</h4>
      ...
      {/* よくあるお問い合わせ */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">よくあるお問い合わせ</h2>
        <div className="space-y-4">
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. サイトに掲載されている業者の情報は正確ですか？</h3>
            <p className="text-sm text-gray-700">
              A. 2026年3月時点の最新情報を掲載していますが、業者の情報は変更される可能性があります。最新情報は各業者の公式サイトでご確認ください。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. サイトに掲載してほしい業者があります</h3>
            <p className="text-sm text-gray-700">
              A. お問い合わせフォームまたはメールで業者名をお知らせください。古物商許可取得済みの業者であれば掲載を検討いたします。
            </p>
          </div>
          <div className="border-l-4 border-primary-400 pl-4">
            <h3 className="font-bold mb-2">Q. サイトの情報に誤りがあります</h3>
            <p className="text-sm text-gray-700">
      ...
      <section className="grid md:grid-cols-2 gap-4">
        <a href="/faq" className="block bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
          <h3 className="font-bold mb-2">よくある質問（FAQ）→</h3>
          <p className="text-gray-600 text-sm">お問い合わせ前にご確認ください</p>
        </a>
