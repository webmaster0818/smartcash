  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        ...
        <p className="text-gray-700">SmartCash（当サイト）のご利用にあたって</p>
      </section>

      {/* サイトの目的 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第1条（サイトの目的）</h2>
      ...
      {/* 免責事項 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第2条（免責事項）</h2>
        <div className="space-y-4 text-gray-700">
          <div>
            <h3 className="font-bold mb-2">1. 情報の正確性について</h3>
            <p>
              当サイトに掲載されている情報は、作成時点での情報に基づいており、その正確性・完全性・最新性を保証するものではありません。掲載内容は予告なく変更される場合があります。
            </p>
          </div>
          <div>
            <h3 className="font-bold mb-2">2. 損害の免責</h3>
            <p>
              当サイトの情報を利用したことにより生じたいかなる損害についても、当サイトは一切の責任を負いません。ユーザーの自己責任においてご利用ください。
            </p>
          </div>
          <div>
            <h3 className="font-bold mb-2">3. 外部サイトについて</h3>
            <p>
      ...
      {/* 著作権・知的財産権 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第3条（著作権・知的財産権）</h2>
        <p className="text-gray-700 mb-4">
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-700 mb-4">当サイトの利用にあたり、以下の行為を禁止します。</p>
      ...
      {/* リンクに関する注意事項 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第5条（リンクに関する注意事項）</h2>
        <p className="text-gray-700 mb-4">
      ...
      {/* 利用規約の変更 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第6条（利用規約の変更）</h2>
        <p className="text-gray-700 mb-4">
      ...
      {/* 準拠法・管轄裁判所 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第7条（準拠法・管轄裁判所）</h2>
        <p className="text-gray-700 mb-4">
