  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <h1 className="text-3xl font-bold mb-4">先払い買取と他サービスの違いを徹底比較【2026年最新版】</h1>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">5つのサービス 一覧比較表</h2>
      ...
      {/* 1. 先払い買取 vs Amazon買取 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">1. 先払い買取 vs Amazon買取</h2>
        <div className="space-y-4">
          <div>
            <h3 className="font-bold mb-2">換金率</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gray-50 p-4 rounded">
                <p className="font-bold mb-1">先払い買取: 60〜80%</p>
                <p className="text-sm text-gray-600">10万円 → 6〜8万円</p>
              </div>
              <div className="bg-green-50 p-4 rounded">
                <p className="font-bold mb-1 text-green-700">Amazon買取: 80〜90% ✓</p>
                <p className="text-sm text-gray-600">10万円 → 8〜9万円</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 mt-2">→ Amazon買取の方が換金率が高い</p>
          </div>

          <div>
            <h3 className="font-bold mb-2">振込時間</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
            ...
            <p className="text-sm text-gray-600 mt-2">→ 先払い買取の方が速い</p>
          </div>

          <div>
            <h3 className="font-bold mb-2">必要なもの</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
                <p className="font-bold mb-1 text-green-700">先払い買取: クレカ不要 ✓</p>
                <p className="text-sm text-gray-600">商品券があればOK</p>
              </div>
              <div className="bg-gray-50 p-4 rounded">
                <p className="font-bold mb-1">Amazon買取: クレカ必要</p>
                <p className="text-sm text-gray-600">Amazonギフト券を購入</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 mt-2">→ クレカがない方は先払い買取のみ利用可能</p>
          </div>

          <div className="bg-blue-50 p-4 rounded">
            <h3 className="font-bold mb-2">どちらを選ぶべき？</h3>
      ...
      {/* 2. 先払い買取 vs 後払い現金化 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">2. 先払い買取 vs 後払い現金化</h2>
        <div className="space-y-4">
          <div>
            <h3 className="font-bold mb-2">審査</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
              ...
              <div className="bg-gray-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">後払いアプリの審査</p>
              </div>
            </div>
          </div>

          <div>
            <h3 className="font-bold mb-2">金融ブラックの利用</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
              ...
              <div className="bg-gray-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">審査に通らない</p>
              </div>
            </div>
          </div>

          <div>
            <h3 className="font-bold mb-2">法的リスク</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
      ...
      {/* 3. 先払い買取 vs クレカ現金化 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">3. 先払い買取 vs クレジットカード現金化</h2>
        <div className="space-y-4">
          <div>
            <h3 className="font-bold mb-2">クレジットカードの必要性</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
          ...
          <div>
            <h3 className="font-bold mb-2">規約違反のリスク</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
              ...
              <div className="bg-red-50 p-4 rounded">
                ...
                <p className="text-sm text-gray-600">カード会社の規約違反</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">4. 先払い買取 vs 給料ファクタリング</h2>
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold mb-2">在籍確認</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 p-4 rounded">
                <p className="font-bold mb-1 text-green-700">先払い買取: なし ✓</p>
              </div>
      ...
      <section className="bg-primary-50 rounded-lg p-6">
        ...
        <div className="space-y-3">
          <div>
            <h3 className="font-bold mb-2">先払い買取はこんな方におすすめ</h3>
            <ul className="space-y-1 text-sm">
