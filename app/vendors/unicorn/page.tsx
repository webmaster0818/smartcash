    ...
    <div className="space-y-8">
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">ユニコーン</h1>
            <p className="text-sm md:text-base text-gray-700">独立系として安定したサービスを提供</p>
          </div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 text-center">
          ...
          <div className="bg-white p-3 md:p-4 rounded"><div className="text-xs md:text-sm text-gray-600 mb-1">営業時間</div><div className="text-base md:text-lg lg:text-xl font-bold">10:00-19:00</div></div>
      ...
      <section className="bg-white p-4 md:p-6 rounded-lg shadow">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-4">ユニコーンの特徴</h2>
        <ul className="space-y-3 text-sm md:text-base">
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>丁寧な接客対応</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>シンプルな手続き</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>最短10分での振込</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>WEB完結型</span></li>
        </ul>
      </section>
