    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">リッチ</h1>
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-blue-600">京都府 第613234567890号</td>
            </tr>
            <tr>
