    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">チケットセンター</h1>
            <p className="text-sm md:text-base text-gray-700">運営実績5年以上の安心と信頼の老舗業者</p>
          </div>
        </div>
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="border-l-4 border-green-400 pl-4 py-2">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs md:text-sm text-gray-600">50代 男性</span>
            </div>
