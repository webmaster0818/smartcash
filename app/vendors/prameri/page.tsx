export default function Prameri() {
  return (
    <div className="space-y-8">
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">プラメリ</h1>
            <p className="text-sm md:text-base text-gray-700">株式会社MED運営の独立系先払い買取</p>
          </div>
        </div>
      ...
      <section className="bg-white p-4 md:p-6 rounded-lg shadow">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-4">プラメリの特徴</h2>
        <ul className="space-y-3 text-sm md:text-base">
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>独自の査定基準で柔軟な対応</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>親切で丁寧なスタッフ対応</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>最短10分でのスピード振込</span></li>
          <li className="flex items-start gap-2"><span className="text-primary-600 font-bold">✓</span><span>初めての方でも安心</span></li>
        </ul>
      </section>
