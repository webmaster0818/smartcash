    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">born（ボーン）</h1>
            <p className="text-sm md:text-base text-gray-700">換金率最大87%・最短12分振込の先払い買取業者</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-green-600">最大87%</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-xs md:text-sm text-gray-600 mb-1">振込時間</div>
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-red-600">最短12分</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-xs md:text-sm text-gray-600 mb-1">営業時間</div>
            <div className="text-lg font-bold">9:00-20:00</div>
          </div>
        </div>
      </section>
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            <tr>
              ...
              <td className="py-3 px-4">born（ボーン）</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">換金率</th>
              <td className="py-3 px-4 font-bold text-green-600">最大87%</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">振込時間</th>
              <td className="py-3 px-4 font-bold text-red-600">最短12分</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">営業時間</th>
              <td className="py-3 px-4">9:00-20:00（年中無休）</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-blue-600">静岡県 第221234567890号</td>
            </tr>
            <tr>
        ...
        <div className="bg-green-50 rounded-lg p-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>換金率最大87%を実現</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span>最短12分で振込完了</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: 4, title: '振込', desc: '最短12分で指定口座に振込完了' },
          ].map((item) => (
