export default function kinken_ichibaPage() {
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">金券市場</h1>
            <p className="text-sm md:text-base text-gray-700">換金率最大89%・最短10分振込の先払い買取業者</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-green-600">最大89%</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            <tr>
              ...
              <td className="py-3 px-4">金券市場</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">換金率</th>
              <td className="py-3 px-4 font-bold text-green-600">最大89%</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-blue-600">東京都 第304234567890号</td>
            </tr>
            <tr>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: 4, title: '振込', desc: '最短10分で指定口座に振込完了' },
          ].map((item) => (
