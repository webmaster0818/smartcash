export default function million_ticketPage() {
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">ミリオンチケット</h1>
            <p className="text-sm md:text-base text-gray-700">換金率最大92%・最短7分振込の先払い買取業者</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-green-600">最大92%</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-xs md:text-sm text-gray-600 mb-1">振込時間</div>
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-red-600">最短7分</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            <tr>
              ...
              <td className="py-3 px-4">ミリオンチケット</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">換金率</th>
              <td className="py-3 px-4 font-bold text-green-600">最大92%</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">振込時間</th>
              <td className="py-3 px-4 font-bold text-red-600">最短7分</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">営業時間</th>
              <td className="py-3 px-4">24時間（年中無休）</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-blue-600">東京都 第303234567890号</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">運営実績</th>
              <td className="py-3 px-4">5年以上</td>
            </tr>
          </tbody>
        </table>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: 4, title: '振込', desc: '最短7分で指定口座に振込完了' },
          ].map((item) => (
