    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">MOOMIN</h1>
            <p className="text-gray-700">女性スタッフ対応で初心者にも優しいサービス</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-2xl font-bold text-green-600">最大82%</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-sm text-gray-600 mb-1">振込時間</div>
            <div className="text-2xl font-bold text-red-600">最短20分</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
      ...
      <section className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-green-400 pl-4 py-2">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-yellow-500">⭐⭐⭐⭐</span>
              <span className="text-sm text-gray-600">20代 女性</span>
            </div>
            <p className="text-gray-700">
