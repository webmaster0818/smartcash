    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">アーリーチケット</h1>
            <p className="text-sm md:text-base text-gray-700">業界トップクラスの換金率93%と最短5分振込</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-lg md:text-xl lg:text-2xl font-bold text-green-600">最大93%</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            <tr>
              ...
              <td className="py-3 px-4">アーリーチケット</td>
            </tr>
            <tr>
              <th className="py-3 px-4 text-left bg-gray-50">換金率</th>
              <td className="py-3 px-4 font-bold text-green-600">最大93%（58%〜）</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4">JCBギフトカード、Amazonギフト券、全国百貨店共通商品券など全般</td>
            </tr>
            <tr>
        ...
        <div className="bg-green-50 rounded-lg p-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>業界トップクラスの換金率（最大93%）</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span>最短5分で振込完了（即日対応）</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span>朝9時から夜22時まで営業</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
        ...
        <div className="bg-red-50 rounded-lg p-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>24時間営業ではない（夜22時まで）</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>最低換金率が58%とやや低め</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
      ...
      <section className="bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: 4, title: '振込', desc: '最短5分で指定口座に振込完了' },
          ].map((item) => (
