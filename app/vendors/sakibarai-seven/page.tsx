export default function sakibarai_sevenPage() {
  return (
    <div className="space-y-8">
      {/* ヘッダー */}
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          <div className="text-4xl md:text-6xl">7️⃣</div>
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">先払いセブン</h1>
            <p className="text-sm md:text-base text-gray-700">換金率最大86%・最短12分振込の先払い買取業者</p>
          </div>
        </div>
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-lg font-bold">10:00-22:00</div>
          </div>
        </div>
      </section>
        ...
        <table className="w-full text-sm">
          <tbody className="divide-y">
            <tr>
              ...
              <td className="py-3 px-4">先払いセブン</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4">10:00-22:00（年中無休）</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-blue-600">神奈川県 第452234567890号</td>
            </tr>
            <tr>
