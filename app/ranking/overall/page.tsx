    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 md:p-8 rounded-lg">
        <div className="flex items-center gap-3 md:gap-4 mb-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 leading-tight">総合ランキングTOP12【2026年最新版】</h1>
            <p className="text-sm md:text-base text-gray-700">換金率・振込スピード・安全性を総合評価</p>
          </div>
        </div>
      </section>
