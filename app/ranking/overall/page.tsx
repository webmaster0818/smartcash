  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        <h1 className="text-3xl font-bold mb-4">先払い買取 総合ランキング【2026年最新版】</h1>
      ...
      <section className="bg-gray-50 rounded-lg p-6">
        <h2 className="text-2xl font-bold mb-4">業者の選び方</h2>
        <div className="space-y-4">
          <div>
            <h3 className="font-bold mb-2">🎯 換金率を重視する方</h3>
            <p className="text-gray-700">
              シープチケット（最大95%）やタートルチケット（最大90%）がおすすめです。
            </p>
          </div>
          <div>
            <h3 className="font-bold mb-2">⚡ スピードを重視する方</h3>
            <p className="text-gray-700">
              最短5分振込のシープチケットが最速です。
            </p>
          </div>
          <div>
            <h3 className="font-bold mb-2">🛡️ 安全性を重視する方</h3>
            <p className="text-gray-700">
