  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-primary-100 p-8 rounded-lg">
        ...
        <p className="text-gray-700">SmartCash（当サイト）の個人情報保護方針</p>
      </section>

      {/* 個人情報の取り扱い */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第1条（個人情報の取り扱い）</h2>
        <p className="text-gray-700 mb-4">
          SmartCash（以下「当サイト」）は、ユーザーの個人情報保護を重要な責務と認識し、適切な管理・保護に努めます。
        </p>
        <div className="bg-blue-50 p-4 rounded">
          <h3 className="font-bold mb-2">当サイトが取得する情報</h3>
      ...
      {/* 個人情報の利用目的 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第2条（個人情報の利用目的）</h2>
        <p className="text-gray-700 mb-4">当サイトは、取得した個人情報を以下の目的で利用します。</p>
      ...
      {/* Cookieの使用 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第3条（Cookieの使用）</h2>
        <p className="text-gray-700 mb-4">
          当サイトは、ユーザーの利便性向上およびサイト改善のため、Cookieを使用します。
        </p>
        <div className="space-y-4 text-gray-700">
          <div>
            <h3 className="font-bold mb-2">Cookieとは</h3>
            <p>
              Cookieとは、ウェブサイトがユーザーのブラウザに保存する小さなテキストファイルです。再訪問時にユーザーを識別し、利便性を向上させます。
            </p>
          </div>
          <div>
            <h3 className="font-bold mb-2">Cookieの無効化</h3>
            <p>
      ...
      {/* アクセス解析ツール */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第4条（アクセス解析ツール）</h2>
        <p className="text-gray-700 mb-4">
          当サイトは、Google Analyticsなどのアクセス解析ツールを使用しています。これらのツールはCookieを使用してユーザーの行動データを収集します。
        </p>
        <div className="bg-blue-50 p-4 rounded">
          <h3 className="font-bold mb-2">Google Analyticsについて</h3>
          <ul className="space-y-1 text-sm text-gray-700">
      ...
      {/* 第三者提供 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第5条（第三者提供）</h2>
        <p className="text-gray-700 mb-4">
      ...
      {/* 個人情報の開示・訂正・削除 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第6条（個人情報の開示・訂正・削除）</h2>
        <p className="text-gray-700 mb-4">
      ...
      {/* 個人情報の安全管理 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第7条（個人情報の安全管理）</h2>
        <p className="text-gray-700 mb-4">
      ...
      {/* プライバシーポリシーの変更 */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">第8条（プライバシーポリシーの変更）</h2>
        <p className="text-gray-700 mb-4">
      ...
      <section className="bg-blue-50 p-6 rounded-lg">
        ...
        <a href="/contact" className="inline-block bg-primary-600 text-white px-6 py-2 rounded-lg hover:bg-primary-700 transition">
          お問い合わせ →
        </a>
      </section>

      {/* 制定日 */}
      <section className="text-right text-gray-600">
        <p>制定日：2026年3月23日</p>
      </section>
    </div>
  )
